...
export const useSelectedWorkspaceContext = () =>
	useContext<ISelectedWorkspaceContext>(SelectedWorkspaceContext);

export const SelectedWorkspaceContextProvider: React.FC<{
	...
	return (
		<SelectedWorkspaceContext.Provider value={data}>
			{children}
